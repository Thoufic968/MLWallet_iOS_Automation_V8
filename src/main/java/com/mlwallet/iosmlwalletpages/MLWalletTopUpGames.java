...
public class MLWalletTopUpGames {
    ...
    public static By objTopUpGames = By.xpath("//*[@name='1UIPCH']/descendant::XCUIElementTypeOther[3]");
    
    public static By objTopGamesPage = By.xpath("(//*[@name=''])[3]/XCUIElementTypeOther[1]");
