...
import com.mlwallet.ios_scripts.MLWalletCashOutWithdrawScripts;
...
public class ExtentReporter implements ITestListener  {
	...
	MLWalletCashOutWithdrawScripts ob=new MLWalletCashOutWithdrawScripts();
...
//	}
	...
	public void initExtentDriver() {
		...
		else if (getPlatformFromtools().equals("MLWallet_iOS") ) {
			src = ((TakesScreenshot) getDriver()).getScreenshotAs(org.openqa.selenium.OutputType.FILE);
		}
	}
	...
	public void onStart(ITestContext context) {
		...
		if (!getPlatform().equals("Web")&&(!getPlatform().equals("MLWallet_iOS"))) {
...
//======================================new lines====================================================			
			 if (!getPlatformFromtools().equals("MLWallet_iOS")) {
...
//	}
	...
	public void onFinish(ITestContext context) {
		if (!getPlatformFromtools().equals("Web")&&(!getPlatformFromtools().equals("MLWallet_iOS"))){
...
//									.getParameter("userType")
	...
	public void appVersion() {
		if (getPlatform().equals("Android") || getPlatform().equals("HIPI") || getPlatform().equals("MLWallet_iOS")) {
