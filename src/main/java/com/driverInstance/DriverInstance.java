...
//			iOScapabilities.setCapability("useNewWDA", false);
//			capabilities.setCapability("webDriverAgentUrl", "http://realDeviceIPAddress:8100");
			...
			}else if(application.equalsIgnoreCase("mlwallet")){//com.mlhuillier.mlwallet  com.google.chrome.ios
				iOScapabilities.setCapability(IOSMobileCapabilityType.BUNDLE_ID, "com.mlhuillier.mlwallet");
				iOScapabilities.setCapability(IOSMobileCapabilityType.COMMAND_TIMEOUTS, 300);
				logger.info("Tapping on MLWallet app");
